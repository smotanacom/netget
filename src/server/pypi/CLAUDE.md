...
halves; the constants and the reasoning live beside them in `src/server/pypi/mod.rs`.
...
`tests/server/pypi/connection_bounds_test.rs` drives all three from the wire, over
