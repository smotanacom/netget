...
halves; the constants and the reasoning live beside them in `src/server/sqs/mod.rs`.
...
`tests/server/sqs/connection_bounds_test.rs` drives all three from the wire, over
