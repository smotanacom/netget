...
**Maturity: Experimental.** BLE Health Thermometer Service (0x1809) - body/ambient temperature measurement
...
- **`00001809-0000-1000-8000-00805f9b34fb`**
  - `00002a1c-0000-1000-8000-00805f9b34fb` [indicate]
  - `00002a1e-0000-1000-8000-00805f9b34fb` [notify]
  - `00002a1d-0000-1000-8000-00805f9b34fb` [read] — initial value `02`
...
- `device_name` (string, optional) — advertised name, default `NetGet-Thermometer`
...
`tests/server/bluetooth_ble_thermometer/` exists, is declared in `tests/server/mod.rs`, and its
...
"BLUETOOTH_BLE_THERMOMETER"` reaches this protocol's `spawn`, that the base brings the radio up, and that a
`bluetooth_ble_started` event is raised and answered by the mocked model. That is real coverage
of the *wiring* and **no coverage of the profile**: nothing in it builds the Health Thermometer Service (0x1809), puts a byte
