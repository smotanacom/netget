...
**Maturity: Experimental.** BLE Battery Service (0x180F) - report battery level as a percentage
...
`tests/server/bluetooth_ble_battery/gatt_examples_test.rs` pins both rules.
