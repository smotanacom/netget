...
pub struct BluetoothBleEnvironmental;
impl BluetoothBleEnvironmental {
    ...
    pub async fn spawn_with_llm_actions(
        ...
        crate::server::bluetooth_ble::BluetoothBle::spawn_with_llm_actions(
            ...
            id,
            {
                ...
                if inst.is_empty() {
                    "Configure as a BLE Environmental Sensing Service (0x181A).".to_string()
                } else {
                    format!("{inst}. Configure as a BLE Environmental Sensing Service (0x181A).")
                }
            },
        )
        .await
...
#[cfg(not(feature = "bluetooth-ble-environmental"))]
impl BluetoothBleEnvironmental {
    pub async fn spawn_with_llm_actions(
        _: String,
        ...
        anyhow::bail!("BLE environmental not enabled")
    }
}
