...
halves; the constants and the reasoning live beside them in `src/server/dynamo/mod.rs`.
...
`tests/server/dynamo/connection_bounds_test.rs` drives all three from the wire, over
