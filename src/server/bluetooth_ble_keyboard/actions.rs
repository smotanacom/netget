//! BLE HID keyboard (0x1812) - HID-over-GATT keyboard a host can pair with
//!
...
impl Default for BluetoothBleKeyboardProtocol {
    fn default() -> Self {
        Self::new()
    }
}
...
impl Protocol for BluetoothBleKeyboardProtocol {
    fn get_startup_parameters(&self) -> Vec<ParameterDefinition> {
        vec![ParameterDefinition {
            ...
            description: "Bluetooth device name to advertise (default: NetGet-Keyboard)"
                .to_string(),
            required: false,
    ...
    fn metadata(&self) -> crate::protocol::metadata::ProtocolMetadataV2 {
        ...
        ProtocolMetadataV2::builder()
            ...
            // cannot satisfy, which the central surfaces as a failed read. No keystroke is invented.
            .answers_on_failure()
            .implementation(
                "bluetooth-ble base stack (ble-peripheral-rust) plus an instruction preamble for the HID Service (0x1812) in keyboard mode",
            )
            .llm_control(
    ...
    fn example_prompt(&self) -> &'static str {
        "Act as a Bluetooth keyboard. Once a host subscribes to the input report, type 'hi'."
    }
    ...
    fn get_startup_examples(&self) -> crate::llm::actions::StartupExamples {
        ...
        StartupExamples::new(
            ...
            json!({
                ...
                "instruction": "Act as a Bluetooth keyboard. Once a host subscribes to the input report, type 'hi'.",
                "startup_params": {
    ...
    ) -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<std::net::SocketAddr>> + Send>>
    {
        Box::pin(async move {
            let device_name = ctx
                ...
                .transpose()?
                .flatten()
                .unwrap_or_else(|| "NetGet-Keyboard".to_string());
