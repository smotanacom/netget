//! BLE Weight Scale Service (0x181D) - weight measurement and scale features
//!
...
impl BluetoothBleWeightScaleProtocol {
    pub fn new() -> Self {
        Self
    }
...
impl Default for BluetoothBleWeightScaleProtocol {
    fn default() -> Self {
        Self::new()
    }
}
...
impl Protocol for BluetoothBleWeightScaleProtocol {
    fn get_startup_parameters(&self) -> Vec<ParameterDefinition> {
        vec![ParameterDefinition {
            ...
            description: "Bluetooth device name to advertise (default: NetGet-WeightScale)"
                .to_string(),
            required: false,
    ...
    fn keywords(&self) -> Vec<&'static str> {
        vec!["bluetooth", "ble", "weight", "scale", "health"]
    }
    ...
    fn example_prompt(&self) -> &'static str {
        "Act as a bathroom scale reading 70.5 kg"
    }
    ...
    fn get_startup_examples(&self) -> crate::llm::actions::StartupExamples {
        ...
        StartupExamples::new(
            ...
            json!({
                ...
                "instruction": "Act as a bathroom scale reading 70.5 kg",
                "startup_params": {
                ...
                "event_handlers": [
                    {
                        ...
                        "handler": {
                            "type": "script",
                            "language": "python",
                            "code": "import json,sys\ne=json.load(sys.stdin)['event']\nv={'00002a9e-0000-1000-8000-00805f9b34fb':'01000000'}.get(str(e.get('characteristic_uuid','')).lower())\nprint(json.dumps({'actions':[{'type':'respond_to_read','value':v}] if v else []}))"
                        }
                    }
                ]
            }),
    ...
    ) -> std::pin::Pin<Box<dyn std::future::Future<Output = Result<std::net::SocketAddr>> + Send>>
    {
        Box::pin(async move {
            let device_name = ctx
                ...
                .transpose()?
                .flatten()
                .unwrap_or_else(|| "NetGet-WeightScale".to_string());
