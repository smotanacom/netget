# BLE Cycling Service Tests

**2 files, 8 tests**, and this doc named none of them until 22 September 2026.

| file | tests | what it holds |
|---|---|---|
| `e2e_test.rs` | 1 | the service starting and answering, with the model driving it |
| `gatt_examples_test.rs` | 7 | **every UUID and value byte in the startup examples, against the SIG layout** |
...
Tests validate Cycling Speed and Cadence Service (0x1816).
