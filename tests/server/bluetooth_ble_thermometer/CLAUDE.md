...
**2 files, 9 tests**, and this doc named none of them until 22 September 2026.

| file | tests | what it holds |
|---|---|---|
| `e2e_test.rs` | 1 | the service starting and answering, with the model driving it |
| `gatt_examples_test.rs` | 8 | **every UUID and value byte in the startup examples, against the SIG layout** |
